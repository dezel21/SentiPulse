...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.sentipulse.web.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.sentipulse.web.security.DomainUserDetailsService", "createSpringSecurityUser");
